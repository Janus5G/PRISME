...
**[Åbn PRISME-demo i din browser](https://jfrfrfn.github.io/PRISME/)** — ingen installation, kører direkte.
...
**Online:** [**▶ Åbn PRISME-demo**](https://jfrfrfn.github.io/PRISME/) — kører direkte i browseren.
...
```bash
git clone https://github.com/jfrfrfn/PRISME.git
cd PRISME
...
```bash
wget https://github.com/jfrfrfn/PRISME/archive/refs/heads/main.zip -O prisme.zip
unzip prisme.zip
cd PRISME-main
unzip optical-routing-simulator.zip -d ors
cd ors
